...
export const meta = {
  date: "2023-08-18",
  title: "College of Engineering Student Archeet Shah on why he chose to add supply chain as a minor",
  description:
    "Purdue Professor Tanoos highlights Archeet Shah’s perspective on supply chain education.",
  image: "/images/me.jpg",
  tags: ["Supply Chain Engineering Technology", "Purdue Professor Jim Tanoos"],
  externalUrl: "https://jimtanoos.com/2025/10/28/college-of-engineering-student-archeet-shah-on-why-he-chose-to-add-supply-chain-as-a-minor/"
};
...
[Read the full article on Jim Tanoos' website](https://jimtanoos.com/2025/10/28/college-of-engineering-student-archeet-shah-on-why-he-chose-to-add-supply-chain-as-a-minor/)
